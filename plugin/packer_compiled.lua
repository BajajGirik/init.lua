...
_G.packer_plugins = {
  ...
  ["cloak.nvim"] = {
    loaded = true,
    path = "/Users/mac/.local/share/nvim/site/pack/packer/start/cloak.nvim",
  ...
  ["lsp-zero.nvim"] = {
    loaded = true,
    path = "/Users/mac/.local/share/nvim/site/pack/packer/start/lsp-zero.nvim",
  ...
  ["refactoring.nvim"] = {
    loaded = true,
    path = "/Users/mac/.local/share/nvim/site/pack/packer/start/refactoring.nvim",
